...
<main>
    ...
    --invalid -->
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <span
                class="form__error"><?= isset($errors['password']) ? $errors['password'] = 'Введите пароль' : '' ?></span>
        </div>
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <span
                class="form__error"><?= isset($errors['contacts']) ? $errors['contacts'] = 'Напишите как с вами связаться' : '' ?></span>
        </div>
